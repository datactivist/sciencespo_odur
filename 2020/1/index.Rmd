...
- **After each class: a form to submit** : 
  ...
  - To be submitted 48 hours after sent 

- **Final Exam** : .red[**DEADLINE OCT 15**]
  - **50% of your total grade**: a 2-pages (graph/map included) note, **.red[1]** page of annex **MAX** allowed, for your Head of cabinet with the main result you got by analysing this data
    ...
    - Share the results on Github (or other Git tools) with documentation
...
.center[<im
g src="./ihttps://datactivist.coop/ubordeaux//recensement3.pg" height="350"/>] 
...
.center[<img src="https://github.com/Gidoin/sciencespodata/raw/master/img/recensement2.png" height="350"/>] 
...
.center[<img src="https://https://github.com/Gidoin/sciencespodata/raw/master/img/recensement1.png" height="350"/>] 
...
.center[<img src="https://github.com/Gidoin/sciencespodata/raw/master/img/hadley.jpg" height="250"/>] 
