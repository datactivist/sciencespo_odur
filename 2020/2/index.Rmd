...
.pull-right[
The Open Data Pipeline is a modelisation of the open data lifecycle in 7 steps based on Samuel Goeta's [research](https://pastel.archives-ouvertes.fr/tel-01458098). 
...
---
### [Workbench](https://workbenchdata.com) to transform data
...
See also [this tutorial](https://infolabs.io/sites/default/files/files/comment_produire_un_fichier_csv_de_qualite_1.1.pdf)
...
---
class: inverse, center, middle
### Let's have a final meeting time?
