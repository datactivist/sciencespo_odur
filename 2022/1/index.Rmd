---
title: "Class 1: Open Data 101"
subtitle: "The origins and principles of a growing movement"
author: "Joël Gombin"
...
params:
  event: Sciences Po Open Data for Urban Research - class 1
...
These slides online: `r paste0("http://datactivist.coop/", params$slug, "/2022/1/")`
...
.center[*The content of this presentation is partly inspired by [Timothée Gidoin's class at Sciences Po](https://gidoin.github.io/sciencespodata/lesson2_opendata.html#1).*]
...
- Datactivist is a French cooperative company specialised in open data created in 2016 with a mission to .red[**open data and make them useful**].
...
---
### Syllabus update: .red[next classes]
...
Date: October 21, 2022 (12:30pm - 4:45pm)
...
---
### Syllabus update: .red[objectives of this course]
...
- know how datasets are concretely opened and used
...
---
### Syllabus update: .red[grading]

- **After each class: a form to submit** : 
  - **50% of your total grade** 
  - Individual exercise during or after the class 
  - Short questions to ensure you understood course materials
  - To be submitted before next class (or within a week)

- **Final Exam** : .red[**DEADLINE OCT 28**]
  - **50% of your total grade**: a 2-pages (graph/map included) note, **.red[1]** page of annex **MAX** allowed, for the Chief of Staff of the City Hall with the main result you got by analysing this data
    - Find an interesting dataset opened by govt or local authorities or public companies related to urban matter.
    - Analyze the data, cross the data to strenghten your analysis, transform the data to produce a graph or a map displaying the key results
    - If relevant, provide a real policy recommendation based on your results
    - Explain the limits of the data you worked with (quality, scope, granularity..)
...
.center[<img src="https://gidoin.github.io/sciencespodata/img/guidepratique.png" height="300"/>]
...
.pull-left[
![](https://gidoin.github.io/sciencespodata/img/kitchin.jpg)
]
.pull-right[
...
.center[<img src="https://gidoin.github.io/sciencespodata/img/robkitchin.jpg" height="250"/>] 
...
.center[<img src="https://gidoin.github.io/sciencespodata/img/datavizdeaths.png" height="400"/>]
...
.center[<img src="https://gidoin.github.io/sciencespodata/img/tricot.png" height="450"/>]
...
.center[<img src="https://gidoin.github.io/sciencespodata/img/violenceandimmigration.png" height="400"/>]
...
.pull-left[<img src="https://gidoin.github.io/sciencespodata/img/ainbnb1.png" height="250"/>

Number of Airbnb appartments available in Paris
]

.pull-right[<img src="https://gidoin.github.io/sciencespodata/img/airbnb2.png" height="250"/>
...
# The origins of open data

---
### [.red[The multiple facets of open data :]](https://books.openedition.org/cdf/5005?lang=fr) la transparence

Strenghten (_accountability_) and reduce information asymetries

.reduite[
![](https://datactivist.coop/aaf/img/ddhc.png)
]
---
### [.red[The multiple facets of open data: :]](https://books.openedition.org/cdf/5005?lang=fr) freedom of information

In the linkage of cybernetics and free software movements

.reduite.center[![](https://farm7.static.flickr.com/6197/6073305958_19c2bbef40_o.jpg)]

---

###  [.red[The multiple facets of open data: :]](https://books.openedition.org/cdf/5005?lang=fr) data-driven science

.reduite.center[![](http://images.wisegeek.com/physical-data.jpg)]

---

### [.red[The multiple facets of open data:]](https://books.openedition.org/cdf/5005?lang=fr) data industry
...
### [.red[The multiple facets of open data:]](https://books.openedition.org/cdf/5005?lang=fr) transform government
...
---
### Open data : key milestones (in France - compare to your home country?)

![](https://gidoin.github.io/sciencespodata/img/chrono.png)
...
.pull-right[
![](https://gidoin.github.io/sciencespodata/img/photofamille.jpg)
]
...
Take time to inquire about the state of open data rules in your home country!  
...
.center[<img src="https://gidoin.github.io/sciencespodata/img/oecd.png" height="300"/>]
...
.center[<img src="https://gidoin.github.io/sciencespodata/img/gouvouvert.png" height="420"/>]
...
.center[<img src="https://gidoin.github.io/sciencespodata/img/ogp.png" height="200"/>] 
...
.center[<img src="https://github.com/Gidoin/sciencespodata/raw/master/img/datagouvfr.png" height="250"/>] 
...
.center[<img src="./img/datagapsclean.jpg" height="280" />]
...
.center[<img src="https://datactivist.coop/ubordeaux/img/recensement.png" height="350"/>] 
...
.center[[<img src="https://github.com/Gidoin/sciencespodata/raw/master/img/etic.png" height="400"/>](https://data.education.gouv.fr/explore/dataset/fr-en-etic_1d/table/)]

---

### Challenge 1 : data findability

.center[<img src="https://github.com/Gidoin/sciencespodata/raw/master/img/metadonnees.png" height="400"/>]
...
.center[<img src="https://github.com/Gidoin/sciencespodata/raw/master/img/googledataset.png" height="350"/>]
...
![](https://github.com/Gidoin/sciencespodata/raw/master/img/odb.png)


---
### Challenge 2 : data quality

![](https://github.com/Gidoin/sciencespodata/raw/master/img/odb2.png)
...
![](https://github.com/Gidoin/sciencespodata/raw/master/img/deception.gif)
...
.center[<img src="https://raw.githubusercontent.com/Gidoin/sciencespodata/master/img/recensement2.png" height="350"/>]
...
.center[<img src="https://raw.githubusercontent.com/Gidoin/sciencespodata/master/img/recensement1.png" height="350"/>] 
...
.center[<img src="https://github.com/Gidoin/sciencespodata/raw/master/img/openrefine.png" height="400"/>] 
...
.center[<img src="https://github.com/Gidoin/sciencespodata/raw/master/img/csvgenerator.png" height="400"/>] 
...
[.center[<img src="https://github.com/Gidoin/sciencespodata/raw/master/img/hadley.jpg" height="250"/>]](https://en.wikipedia.org/wiki/Hadley_Wickham)
...
.center[<img src="https://garrettgman.github.io/images/tidy-1.png" height="200"/>] 
...
Contact : [joel.gombin@sciencespo.fr](mailto:joel.gombin@sciencespo.fr)
